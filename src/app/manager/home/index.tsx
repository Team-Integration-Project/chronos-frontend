...
const ACTIONS = [
  { id: "1", title: "Relatórios", icon: "document-text-outline", route: "/manager/reports" },
  { id: "2", title: "Justificativas", icon: "person-remove-outline", route: "/manager/manager-justifications" },
  { id: "3", title: "Bater Ponto", icon: "scan-circle-outline", route: "/manager/clock-in" },
  { id: "4", title: "Perfil", icon: "person-circle-outline", route: "/manager/profile" },
];
